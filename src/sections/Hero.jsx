    ...
    <section id="home" className="min-h-screen flex items-center pt-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-accent-indigo font-semibold tracking-wider mb-4">WELCOME TO MY PORTFOLIO</h2>
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              I'm <span className="accent-gradient-text">Aditya</span><br />
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a href="#projects" className="px-6 py-3 border border-white/10 hover:bg-white/5 text-white font-semibold rounded-full transition-all flex items-center gap-2">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute inset-0 bg-accent-indigo/20 blur-[120px] rounded-full"></div>
            <div className="relative z-10 aspect-square w-full max-w-[450px] mx-auto glass-card p-4 overflow-hidden group">
              ...
              {/* Subtle Glow Effect */}
              <div className="absolute inset-0 border-2 border-accent-indigo/30 rounded-2xl group-hover:border-accent-violet/50 transition-colors"></div>
            </div>
          </motion.div>
        </div>
      </div>
