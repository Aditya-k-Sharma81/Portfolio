            ...
            >
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                <div>
                  ...
                  <p className="text-accent-indigo font-medium">{exp.company}</p>
                </div>
                <span className="text-slate-400 text-sm mt-2 md:mt-0 px-4 py-1.5 bg-white/5 rounded-full border border-white/10">
                  {exp.period}
                </span>
              </div>
              <ul className="space-y-3">
                {exp.points.map((point, pIdx) => (
                  <li key={pIdx} className="flex gap-3 text-slate-400">
                    <span className="mt-1.5 min-w-[6px] h-[6px] bg-accent-indigo rounded-full"></span>
